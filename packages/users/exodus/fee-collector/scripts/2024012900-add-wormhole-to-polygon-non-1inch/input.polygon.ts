...
//Config - Addresses
const MAINNET_DEPOSITOR_TASK = '0xFC5194Ec5797009180218b6E31dbeAb4df1D7eb5'
...
const update: EnvironmentUpdate = {
  ...
  namespace: 'exodus-fee-collector-non-inch',
  steps: [
    //Bridger by time: makes sure that by the end of the period, it bridges everything
    {
      ...
      config: {
        baseBridgeConfig: {
          ...
          taskConfig: {
            baseConfig: {
              smartVault: dependency('2023122800-environment-deploy-non-1inch', 'smart-vault'),
    ...
    {
      from: USERS_ADMIN,
      authorizer: dependency('2023122800-environment-deploy-non-1inch', 'authorizer'),
      changes: [
        {
          where: dependency('2023122800-environment-deploy-non-1inch', 'smart-vault'),
          revokes: [],
          grants: [
            {
        ...
        {
          where: dependency('2023122800-environment-deploy-non-1inch', 'connext-bridger'),
