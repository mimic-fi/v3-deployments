      ...
      changes: [
        {
          ...
          grants: [
            {
              who: dependency('migration-claimer-v4'),
              what: 'call',
              params: [],
            },
            {
        ...
        {
          where: dependency('migration-claimer-v4'),
          revokes: [],
          grants: [{ who: dependency('core/relayer/v1.1.0'), what: 'call', params: [] }],
        },
        {
          where: dependency('2024011601-redeploy-migration-task-v3', 'migration-claimer-v3'),
