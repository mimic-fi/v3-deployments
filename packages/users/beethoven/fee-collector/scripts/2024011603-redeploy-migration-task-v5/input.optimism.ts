      ...
      changes: [
        {
          ...
          grants: [
            {
              who: dependency('migration-claimer-v5'),
              what: 'call',
              params: [],
            },
            {
        ...
        {
          where: dependency('migration-claimer-v5'),
          revokes: [],
          grants: [{ who: dependency('core/relayer/v1.1.0'), what: 'call', params: [] }],
        },
        {
          where: dependency('2024011602-redeploy-migration-task-v4', 'migration-claimer-v4'),
