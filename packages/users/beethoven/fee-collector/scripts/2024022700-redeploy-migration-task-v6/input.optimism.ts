      ...
      changes: [
        {
          ...
          grants: [
            {
              who: dependency('migration-claimer-v6'),
              what: 'call',
              params: [],
            },
            {
        ...
        {
          where: dependency('migration-claimer-v6'),
          revokes: [],
          grants: [{ who: dependency('core/relayer/v1.1.0'), what: 'call', params: [] }],
        },
        {
          where: dependency('2024011603-redeploy-migration-task-v5', 'migration-claimer-v5'),
