...
const WRAPPED_NATIVE_TOKEN = tokens.gnosis.WXDAI

//Config - Threshold
const USDC_THRESHOLD = bn(100e6) // 100 USDC
const MIN_NATIVE_TOKEN = fp(0.04)
const MAX_NATIVE_TOKEN = fp(0.4)

//Config - Gas
const STANDARD_GAS_PRICE_LIMIT = 50e9
const TX_COST_LIMIT_PCT = fp(0.05) // 5%
const TEN_TX_GAS = fp(0.006) //10 tx
