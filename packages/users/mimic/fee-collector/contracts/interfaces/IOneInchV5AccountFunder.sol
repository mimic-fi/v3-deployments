...
import '@mimic-fi/v3-tasks/contracts/interfaces/swap/IOneInchV5Swapper.sol';

/**
 * @dev 1inch v5 account fund task interface
 */
interface IOneInchV5AccountFunder is IOneInchV5Swapper {
    /**
