...
//Config - Addresses
const MAINNET_DEPOSITOR_TASK = '0xF126358b7c35741F78DAb5E5E26989B389468630'
const COLLECTOR = '0x15Cd3d7B48AeB927DA262f65090f351E4712943c'
const ROUTER = '0x00000000009726632680FB29d3F7A9734E3010E2'

//Config - Threshold
const USDC_CONVERT_THRESHOLD = bn(20e6) // 20 USDC
const USDC_BRIDGE_THRESHOLD = bn(10000e6) // 10k USDC
